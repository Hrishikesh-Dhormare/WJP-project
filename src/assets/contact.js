              ...
              <div className="col-lg-5 col-md-5">
                ...
                <ul className="info list-unstyled">
                  <li className="d-flex align-items-center">
                    ...
                    <b>Serving the love..</b>
                  </li>
                  <li className="d-flex align-items-center">
                    <span className="pe-3 ti-mobile fs-5"></span>
                    <p className="text-info text-black">+91 9595459595</p>
                  </li>
                  <li className="d-flex align-items-center">
          ...
          <div className="container mt-4">
            <div className="row align-items-center">
              <div className="col-12 col-lg-6 p-1 p-lg-3 text-center text-lg-start">
                <p className="my-0">
                  Copyright © 2023
                  <a href="#">Polar Bear</a> All Rights Reserved
                </p>
              </div>
              <div className="col-12 col-lg-6 p-1 p-lg-3 text-center text-lg-end"></div>
            </div>
          </div>
        </div>
      </footer>
